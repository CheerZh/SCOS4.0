...
public class FoodsFragment1 extends Fragment {
    ...
    private static final String TAG = "FoodsFragment1";

    private View view;        //定义view用来设置fragment的layout
    public RecyclerView mCollectRecyclerView;         //定义RecyclerView

    //定义以goodsentity实体类为对象的数据集合
    private static ArrayList<FoodsEntity> foods_List1 = new ArrayList<>();   //定义食物列表
    private FoodsMenu foods_menu;
    //自定义recyclerveiw的适配器
    public static ColdFoodRecycleAdapter foodsRecyclerAdapter;
...
//        initdata();
    ...
    public static void notifyDataSetChanged(ArrayList<FoodsEntity> newfoods){

        Log.d(TAG, "notifyDataSetChanged: begin");

        foods_List1.clear();
        foods_List1.addAll(newfoods);
...
//        }
            ...
            foods_List1.clear();////先清空
            foods_List1.addAll(foods_menu.getDrinksList());
        }
